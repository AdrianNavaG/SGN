					...
					<div class='card-body card-block'>
						...
						<div class='form-group col-xs-10 col-sm-4 col-md-4 col-lg-4'>
							<label for='fecha_apertura' class=' form-control-label'>Fecha
								...
								class='form-control' value='${fecha_apertura}' readonly>
						</div>
						<div class='form-group col-xs-10 col-sm-4 col-md-4 col-lg-4'>
						...
						<div class='form-group col-xs-10 col-sm-4 col-md-4 col-lg-4'>
							<label for='credito' class='form-control-label'>Credito</label> <input
								type='text' id='credito' placeholder='Ingresa Credito'
								class='form-control'>
						</div>
						<div class='form-group col-xs-10 col-sm-4 col-md-4 col-lg-4'>
						...
						<div
							class='form-group col-xs-10 col-sm-4 col-md-4 col-lg-4 text-right'>
							<button type='button' class='btn btn-outline-primary btn-sm'
								onclick='saveexpedient()'>
